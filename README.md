...
<!--<h3>Table of Contents</h3> --> 
  ...
  <p> <b>tangent:</b> There's some stuff about gender implied here too, with women often being advised to speak confidently and omit the exclamation marks in their writing. I think this is really bad advice overall, and it's just another way to punish femininity. Whether a grammar autocorrect is forcing a political agenda on our ways of communicating is concerning even if, at the core of the issue, I agree with that agenda item and wish double standards would be broken down. Letting software influence our delivery <i>at all</i> is the root of the problem. Not all sentence structures convey the same meaning -- even if they are semantically equivalent -- and machines should not be given power over them.</p>
