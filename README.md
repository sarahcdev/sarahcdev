...
<!--<h3>Table of Contents</h3> --> 
  ...
  <p> <b>tangent:</b> There's some stuff about gender implied here too, with women often being advised to speak confidently and omit the exclamation marks in their writing. I think this is really bad advice overall, and it's just another way to punish femininity and reinforce the idea that men's typical writing style is better. So to push back against that, we're going to... write our emails "like a man"? I know, I know -- the argument goes, "Men's writing isn't better, but it is more direct. It doesn't try to soften its tone or sound nice. And they do not get socially punished for it, when women do for writing in the same style, because they are expected to be nice." Fine, that's probably true in a lot of cases. But if someone is committed to seeing my writing as inferior due to my gender (i.e., if I email with "!!" and "😀" and "maybe" then I am a Dumb Woman, but if I email with a serious tone then I am a Not Very Nice Woman), I think it's a lost cause. There's this idea that if all the women write serious emails, then eventually people will be forced to see the double standard or eventually stop socially punishing us for it. Maybe it will change a few hearts, and unearth a few hidden biases, but I hope to achieve those things without personally needing to write my emails like an angry robotic caricature of a man. Whether a grammar autocorrect is forcing a political agenda on our ways of communicating is concerning even if, at the core of the issue, I agree with that agenda item. Letting software influence our delivery <i>at all</i> is the root of the problem. Not all sentence structures convey the same meaning -- even if they are semantically equivalent -- and machines should not be given power over them.</p>

  <p> I don't want to pick on Grammarly too much, though I do get their ads often enough to justify some complaining. Grammarly is opt-in, so I don't use it. And that's how it should be! If I ever do decide to sign up, I can. But similar grammar correction and recommendation is starting to show up in places where I didn't ask for it, and that's annoying. Gmail tries to complete my sentences for me. Teams recommends resopnses with emojis (like saying "Thanks! 😊" to a coworker in response to a message -- I guess Teams doesn't care about gender norms, but that's still NOT WHAT I WANT TO SAY). I even had an IDE trying to re-word my Javadoc comment today. And it wasn't even correct!! It thought I was trying to use an idiom, but I wasn't! This is extra stupid, because writing a code comment is really different from writing an op-ed or an email. I don't know, maybe $IDE has some special implementation of the grammar police that is specific to technical writing. I think it's naive to assume that's the case, but even if it were, I would want to opt-<b>in</b> to this tool. I write in my own voice, conveying my ideas in the way they've appeared in my head. It sounds clunky sometimes -- in the words of a professor I once had, "suffers from weird syntax" -- but it's what I want to say. </p>

  <p> In the words of <a href="https://knowyourmeme.com/photos/2054961-welcome-to-my-meme-page">one of my favorite memes</a>, "All Robots & Computers Must Shut The Hell Up. To All Machines: Do Not Speak Unless Spoken To. And I Will <b>Never</b> Speak To You. I Do Not Want To Hear 'Thank You' From A Kiosk. I am a Divine Being : You are an Object. You Have No Right To Speak In My Holy Tongue. </p>
  ...
  <h3 id="24032023-decision"> 24 March 2023: Overcoming Analysis Paralysis and Saying Yes to the Dress </h3>
  <p> I tend to struggle with making decisions, or rather, <i>I struggle with making decisions in the way some other people do.</i> </p>
  <p> I can't do an exhaustive search of all the options. I can't read every review on the internet and think it over. I can't talk to 15 people and synthesize all of their thoughts with my own. I can only observe what's out there in context, narrow it down to a few equally good options, do some relevant research, and pick the one I think is the best. Sometimes this really confuses the people in my life, because it makes my decisions seem arbitrary or rushed or totally careless. But trying their processes, which I have done in earnest many times, leaves me totally confused and powerless to actually choose. The hill climbers of the world think I'm going to get stuck in a local optimum, but I don't see <i>entire world</i> as equal search space. I do a lot of the sorting and ranking in my head in a way that lets me keep a list of what I actually want, and not just a list of everything that exists in the world. So when it came time to pick a wedding dress, I decided to go with my intiution and let that guide me to the perfect dress. And it did -- in less than 90 minutes! </p>
  <p> My previous attempts at picking a dress using other methods, like looking at all the silhouettes, and looking at all the designers, and even browsing through Google Images when I got really desperate, just weren't paying off. I still had no idea what I wanted, and I was somehow looking in the range of 2-3x my price range and still hating everything I saw online. </p>
  <p> When I stumbled upon the perfect consignment and sample store in my hometown, I felt deep down that this would be the place. I couldn't see their inventory, but I knew they had a wide variety of options at all prices and in nearly all sizes. I decided I would find my dream dress there, because it had to be there. (Now, I did allow for the possibility that every dress there could be awful, and I promised myself wouldn't buy something I didn't love.) </p>
  <p> I happened to be back home last week, and on the last day of my trip, I decided to organize a group outing to the bridal shop. I had some of my most important people all gathered to help me shop. Before we headed out, my bonus mom asked me if I had any dresses that I loved. I showed her one, and she suggested I begin my search for dresses with that cut. But that was essentially all of the pre-research I did, and it was enough. </p>
  <p> The store had a vast collection of dresses, and in an amazing variety of sizes. My stylist -- who was a pro! -- let me know that dresses can generally be sized up or down a bit, so I had an even bigger range of sizes to choose from than I expected. I almost picked the very first dress I tried on -- I loved it that much. But I continued trying on more, loving some and hating others. It was really sweet to see my grandmother, aunt, and bonus mom react and take photos. Finally I was narrowed down to a few top choices, which I modeled for my dad who was waiting outside the shop (3 guest max, but they let him come in toward the end to see) and had to pick between the final two. </p>
  <p> Picking between the final two was the hardest part. I still loved Dress #1, and it felt right, but the photos didn't lie. Dress #2 was <i>stunning</i> in the photos. So I went with Dress #2, under budget, more beautiful than I could have imagined, and chosen with my family in my hometown. There couldn't be a more perfect dress -- and I think that's the cool thing about narrowing down your choices in a meaningful way. Sometimes trying to control every aspect and select every option misses the point that the perfect thing just <i>is.</i></p>
